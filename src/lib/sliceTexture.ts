...
import { renderRealSlice, type DisplayMode, type Manifest } from "./dataset";
...
export function makeRealSliceTexture(
  ...
  manifest: Manifest,
  k: number,
  opts: { window: number; level: number; showTumor: boolean; mri?: Uint8Array; mode?: DisplayMode; fusion?: number }
): THREE.CanvasTexture {
